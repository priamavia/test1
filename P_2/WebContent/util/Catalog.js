sap.ui.define([
	...
	return Object.extend("cj.pm0101.util.Catalog", { 
		Dailog : [],
		arr_swerk : [],
		arr_kostl : [],
		arr_korks : [],
 ...
 **************************************************************************/				
		_getDialog_Catalog_c : function(){
			...
			if (!this._oDialog_Catalog_c) {
	            this._oDialog_Catalog_c = sap.ui.xmlfragment("cj.pm0101.view.Catalog_pop", this.oMain);
		...
		_getDialog_Catalog_5 : function(){
			...
			if (!this._oDialog_Catalog_5) {
	            this._oDialog_Catalog_5 = sap.ui.xmlfragment("cj.pm0101.view.Catalog_pop", this.oMain);
		...
		_getDialog_Catalog_a : function(){
			...
			if (!this._oDialog_Catalog_a) {
	            this._oDialog_Catalog_a = sap.ui.xmlfragment("cj.pm0101.view.Catalog_pop", this.oMain);
