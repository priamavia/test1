sap.ui.define([
		...
		return {
			...
			makeSerachHelpHeader : function(oMain){
				...
				//Plant section(Pls)
/*				this.woc_fields = [
				    {label: this.oMain.i18n.getText("lblPlantSection"),     key: "Key", searchable:true, iskey:true, search:true },
				    {label: this.oMain.i18n.getText("lblPlantSectionName"), key: "Name", searchable:true, iskey:true, search:true },
				...
				//Dept Code Field
				this.dpt_fields = [
                    {label: this.oMain.i18n.getText("lblDeptCode"),      key: "Key", searchable:true, iskey:true, search:true },
				    {label: this.oMain.i18n.getText("lblDescription"),    key: "Name", searchable:true, iskey:true, search:true }                        
                ];				
			...
			set_search_field : function(oSwerk, Obj, ObjName, mode, param1, param2){
				...
				if(ObjName === "not"){
					...
					this._get_search_Model(Obj, "DPT", urlParameters,  mode, this.oMain.i18n.getText("lblDeptCode"), this.dpt_fields);	
				}
			},
