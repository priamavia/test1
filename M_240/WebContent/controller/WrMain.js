sap.ui.define([
	"sap/ui/base/Object",
	"cj/pm_m240/controller/WorkResult.controller"
], function(Object, WorkResult) {
	"use strict";
	
	return Object.extend("cj.pm_m240.controller.WrMain", { 
		...
		onOpen_workResult : function (MainParam, sMode, sObj) {   // sMode : 조회, 생성 모드 
			...
			if (!this.WorkResult_oDialog) {
				...
				this.WorkResult_oDialog = sap.ui.xmlfragment(this._oView.getId(), "cj.pm_m240.view.WorkResult_pop", this.WorkResult_oDialog_Controller);
