sap.ui.define([
	...
	return Object.extend("cj.pm_m220.util.Catalog", { 
		Dailog : [],
		arr_swerk : [],
		arr_kostl : [],
		arr_korks : [],
		...
		get_catalog_data : function(qkatart, equnr, qmart) {
			this.i18n = this.oMain.oMain.oController.getView().getModel("i18n").getResourceBundle();
			var lange = this.oMain.oMain.oController.getLanguage();
			
			if(this.oMain.sWerks.substring(0,1) == "2"){
				lange = "ZH";
			}
 
			this.oQkatart = qkatart;
			this.Equnr = equnr;
			this.Qmart = qmart;			
		...
		selectCatalog : function(qkatart, mode){
			...
			if(s_catalog.length === 0){
			  errChk = true;
			  	...
			  	var msgText;
				if(qkatart == "B"){
					msgText = this.i18n.getText("isObjectSelectedRow");
				}else if(qkatart == "C"){
					msgText = this.i18n.getText("isDamageSelectedRow");
				}else if(qkatart == "5"){
					msgText = this.i18n.getText("isCauseSelectedRow");
				}else if(qkatart == "A"){
					msgText = this.i18n.getText("isActivitySelectedRow");
				}			  	
 ...
 **************************************************************************/				
		_getDialog_Catalog_c : function(){
			...
			if (!this._oDialog_Catalog_c) {
	            this._oDialog_Catalog_c = sap.ui.xmlfragment("cj.pm_m220.view.Catalog_pop", this.oMain);
		...
		_getDialog_Catalog_5 : function(){
			...
			if (!this._oDialog_Catalog_5) {
	            this._oDialog_Catalog_5 = sap.ui.xmlfragment("cj.pm_m220.view.Catalog_pop", this.oMain);
		...
		_getDialog_Catalog_a : function(){
			...
			if (!this._oDialog_Catalog_a) {
	            this._oDialog_Catalog_a = sap.ui.xmlfragment("cj.pm_m220.view.Catalog_pop", this.oMain);
