sap.ui.define([
	...
	return Object.extend("cj.pm0110.controllers.ValueHelpHelper", {
		aKeys: [],
		theTokenInput: null,
		aTokens : [],
		cols : [],
		...
		selectOption : "",
	    isInput : "",
		constructor: function(model,inputField,config,title,selectOption, parent) {
		...
		//	this.theTokenInput.setTokens(this.aTokens);  //default token이 삭제 되므로 Default 값을 뿌리고 싶을땐 주석 
			this.config = config;
			this.title = title;
