sap.ui.define([
		...
		return {
			...
			set_search_field : function(oSwerk, Obj, ObjName, mode, param1, param2){
				...
				}else if(ObjName === "val"){	// WHEN 'CAC'.  "26
					var type = param1;   // 6
					var urlParameters = {
							"$expand" : "Result" ,
						    "$filter" : "Spras eq '"+ lange + "' and Input1 eq '"+ type +"' and Input2 eq 'ZPM'" 
					}
					this._get_search_Model(Obj, "CAC", urlParameters, mode, "Valuation", this.cac_fields); 
...
//					var kokrs = param1;
			...
			set_eq_filter : function(ObjNm, Val1){
				var str;
				var str1 = Val1;
