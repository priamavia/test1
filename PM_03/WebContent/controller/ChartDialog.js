sap.ui.define([
	...
	return Object.extend("cj.pm0030.controller.ChartDialog", {
		...
		_getDialog : function (oView) {
			...
			if (!this._oDialog) {
				...
				this._oDialog = sap.ui.xmlfragment("cj.pm0030.view.ChartDialog", this);
		...
		open : function (oView) {
			...
			var sel_index = oTable.getSelectedIndex();
			...
			for(var i=0;  i< oTableData.NP_SELECT_LIST.results.length;  i++ ){
				if (oTableData.NP_SELECT_LIST.results[i].Point == oTableData.NP_SELECT_LIST.results[sel_index].Point ){
					var chart_data = {};
		   ...
		   //set graph
			...
			var l_title = this.i18n.getText("chart_title") 
				+  " : " + oTableData.NP_SELECT_LIST.results[sel_index].Psort ;
			// Set Viz properties  
