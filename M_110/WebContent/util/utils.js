...
//                ];
			...
			set_search_field : function(oWerks, Obj, ObjName, mode, param1, param2){
				...
				if(ObjName === "pug"){	// WHEN 'PUG'. 
					...
					this._get_search_Model(Obj, "SBG", urlParameters, mode, this.oMain.i18n.getText("lblSubtype"), this.subtype_fields);					
				...
				}else if(ObjName === "mag"){	// WHEN 'MAG'.
					var urlParameters = {
							"$expand" : "Result" ,
						    "$filter" : "Spras eq '"+ lange  +"'"				
					}
					this._get_search_Model(Obj, "MAG", urlParameters, mode, this.oMain.i18n.getText("lblMatkl"), this.mag_fields);
