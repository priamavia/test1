sap.ui.define([
		"cj/pm0170/controller/BaseController",
		"cj/pm0170/util/ValueHelpHelper",
		"cj/pm0170/util/utils",
		"cj/pm0170/model/formatter",
		...
		return BaseController.extend("cj.pm0170.controller.Main", {
           formatter : formatter,
		/**
	 ...
	 ****************************************************************/
      ...
      //**************************************************************/		
			...
			get_data : function(oEvent){
				...
				var mParameters = {
					...
					for (var i = 0; i < oData.ResultList.results.length; i++) {
					  var oMtbf = parseFloat(oData.ResultList.results[i].Mtbf);
					  
					  oData.ResultList.results[i].Mtbf = oMtbf;			  
					}	
			...
			set_chart : function(){
			    ...
			    var mtbf = this.i18n.getText("mtbf");
			    	
			    var chart_title = this.i18n.getText("chart_title_170");
