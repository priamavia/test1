sap.ui.define([
		"cj/pm0160/controller/BaseController",
		"cj/pm0160/util/ValueHelpHelper",
		"cj/pm0160/util/utils",
		"cj/pm0160/model/formatter",
		...
		return BaseController.extend("cj.pm0160.controller.Main", {
           formatter : formatter,
		/**
	 ...
	 ****************************************************************/
      ...
      //**************************************************************/		
			...
			set_chart : function(){
			    ...
			    var mttr = this.i18n.getText("mttr");
			    	
			    var chart_title = this.i18n.getText("chart_title_160");
