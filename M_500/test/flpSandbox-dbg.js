					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Mobile Analysis Platform",
									"targetURL": "#zcoui0001-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zcoui0001-display": {
								"semanticObject": "zcoui0001",
								"action": "display",
								"description": "Mobile Analysis Platform for CO Module",
								"title": "Mobile Analysis Platform",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zcoui0001",
									"url": sap.ui.require.toUrl("zcoui0001")
								}
							}
						}
					}
