		...
		return {
			...
			makeSerachHelpHeader : function(oMain){
				...
				this.lfa_fields = [
				    ...
				    {label: this.oMain.i18n.getText("lblStcd4"),  key: "Add6", searchable:false, iskey:true, search:true }
                ];
...
//                ];
			...
			set_search_field : function(oWerks, Obj, ObjName, mode, param1, param2){
				...
				}else if(ObjName === "for"){	// WHEN 'FOR'. 
					var lFor = param1;
					var urlParameters = {
							"$expand" : "Result" ,
							"$filter" : "Spras eq '"+ lange + "'"	
					}
					this._get_search_Model(Obj, "FOR", urlParameters, mode, this.oMain.i18n.getText("lblZzclmdb"), this.for_fields);	
