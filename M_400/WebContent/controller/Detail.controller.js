...
//                    "Add5" : oData.results[i].Add5
            ...
            //controll.setMateriaUnit(this.oArgs.Matnr); // Material �� ���� Unit, Price Unit ��ȸ
...
//        this.oWerks.setSelectedKey(this.oWerks.getSelectedKey().getProperty("key"));
      ...
      this.getView().byId("mwskz").setSelectedKey("J1"); " DK - FESC - 02.02.2023
    ...
    _set_search_field : function() {
      ...
      this.oFor = this.getView().byId("Zzclmdb");    // For Type
      if(this.oFor){
        utils.set_search_field("", this.oFor, "for", "C", "", "");
      }
...
//      }
    ...
    set_screen_mode : function(){
      ...
      oView.setModel(new JSONModel({
        ...
        dispMode : true,    //  ����  : true, ���� : false
        editMode : true,    //  ����  : true, ���� : true
        visiMode : true,      //  ����  : true, ���� : true, ��ȸ : false
        deciamlSep : decSep,
        groupingSep : grpSep
      }), "screenMode");
    },
    ...
    get_purchase_order_data : function(){
      ...
      var mParameters = {
          ...
          success : function(oData,response) {
            ...
            controll.setMateriaUnit(oData.HdItem.results[0].Matnr); // Material �� ���� Unit, Price Unit ��ȸ
...
//        });
    ...
    onSave : function(oEvent){
      ...
      if(this.Ebeln){
        data.Ebeln = this.Ebeln;  // Read oData���� ����
      }else{
        data.Ebeln = "";
      }
...
//      data.Zzclmdb 	 = this.getView().byId("Zzclmdb").getSelectedKey();
...
//      data.Inco2L = this.getView().byId("inco1").getSelectedItem().getProperty("text");
      ...
      if(this.Frgzu){
        data.Frgzu = this.Frgzu;   // Read oData���� ����
      }else{
        data.Frgzu = "";
      }
...
//              this.setMateriaUnit(oData.HdItem.results[0].Matnr); // Material �� ���� Unit, Price Unit ��ȸ
