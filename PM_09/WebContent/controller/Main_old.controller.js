...
/*			// 화면 controll
			...
			change_display : function(oData){
			   ...
			   // Aufnr 타입이 'M1'인 경우 Shutdown layout 제어
     	       ...
     	       }else if(oData.UserStatus == "NOS2"){  // 상신
...
//      	    	  }
     	       ...
     	       }else if(oData.UserStatus == "NOS3"){  // 결재
     	       ...
     	       if(oData.SysStatus == "NOCO"){   // Complete, 반려
					   ...
					   if(v_bmcm){
						   ...
						   if(v_bmcm == "NM"){
							   ...
							   return false;						   						
							    ...
							    this.onSave("", "");  // ZBMIND Update 후 Accept 실행
